...
def go_dependencies():
    go_repository(
        ...
        sum = "h1:BST3Y7yWfYPO8qqWhL2KtuqgRCbls6bIr4b4iFCg43I=",
        version = "v0.0.0-20231112215516-51f43a291193",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ybgRdYvAHTn93HW79bLiBiJwVL4jVeyGQRZMgImoeWs=",
        version = "v0.0.0-20240101223322-6e1efdc71b7a",
    )
    go_repository(
        name = "com_github_fyne_io_image",
        importpath = "github.com/fyne-io/image",
        sum = "h1:Fo9Q/ycIlYOhYJ28M+umawPvvcqvVDo/Zp4EZ5750UQ=",
        version = "v0.0.0-20240121103648-c3c798e60e6b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nanQfMsOs3gnuKRm0E5jXWomedE/9YIFXdmHJNZYeqc=",
        version = "v0.0.0-20240118000515-a250818d05e3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JzxbpATK0uq2WpvTX76ofaJA3zuNmYB57FOLuwpRPPs=",
        version = "v0.0.0-20240129162809-b6410f7d78ad",
    )
    go_repository(
        name = "com_github_go_text_typesetting",
        importpath = "github.com/go-text/typesetting",
        sum = "h1:vioSaLPYcHwPEPLT7gsjCGDCoYSbljxoHJzMnKwVvHw=",
        version = "v0.1.0",
    )
    go_repository(
        name = "com_github_go_text_typesetting_utils",
        importpath = "github.com/go-text/typesetting-utils",
        sum = "h1:zBx+p/W2aQYtNuyZNcTfinWvXBQwYtDfme051PR/lAY=",
        version = "v0.0.0-20231211103740-d9332ae51f04",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_goxjs_gl",
        importpath = "github.com/goxjs/gl",
        sum = "h1:zJSqvd6WeaSHaep4NmGZyVjkTsXKCaWbb5G5P+czKME=",
        version = "v0.0.0-20210104184919-e3fafc6f8f2a",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_jackmordaunt_icns_v2",
        importpath = "github.com/jackmordaunt/icns/v2",
        sum = "h1:M7kg6pWRmB+SyCvM058cV2BlAz3MedOHy4e3j2i7FQg=",
        version = "v2.2.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:EdsMzmY5TZujA4xb9xMLIdlp2+zvF7miNYkVXvqqgOQ=",
        version = "v0.9.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:EfOIvIMZIzHdB/R/zVrikYLPPwJlfMcNczJFMs1m6sA=",
        version = "v1.7.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:v2wncjEAcwXZ8UNmTCWTGL9+sGyPc5RuzBvM96GcC78=",
        version = "v2.4.3",
    )
    go_repository(
        name = "io_fyne_systray",
        importpath = "fyne.io/systray",
        sum = "h1:Hvs+kW2VwCzNToF3FmnIAzmivNgrclwPgoUdVSrjkP8=",
        version = "v1.10.1-0.20231115130155-104f5ef7839e",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kfWLZgb8iUBHdE9WydD5V5dHIS/F6HjlBZNyJfn2bs4=",
